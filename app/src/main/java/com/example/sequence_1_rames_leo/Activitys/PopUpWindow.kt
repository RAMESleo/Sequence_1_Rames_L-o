...
import com.example.sequence_1_rames_leo.R.id.popup_window_view_with_border
...
class PopUpWindow  : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnOUI = findViewById(R.id.popup_BtnOui)
        btnNON = findViewById(R.id.popup_BtnNon)
